...
console.log(`PASS: ${pages} pages, local links, footer, visitor counters, local LXGW WenKai, 9 math expressions, TOC, chapter navigation, search index, importer and overwrite protection.`);
